...
window.openCategoryModal = function() {
    // Vì không còn nút quản lý, hàm này vẫn tồn tại nhưng sẽ không được gọi từ sidebar nữa.
    alert("Tính năng quản lý loại đã bị tắt theo yêu cầu. Vui lòng sử dụng 3 loại mặc định.");
    // renderCategoryList();
...
function setGreeting() {
    ...
    // ĐÃ SỬA: Thêm icon FontAwesome vào tiêu đề <h1>
    document.getElementById('greetingMsg').innerHTML = `${msg}, bạn! <i class="fas fa-cloud" style="color:var(--primary)"></i>`;
